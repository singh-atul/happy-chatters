...
export default function Footer() {
  ...
  return (
    <footer
      className="bg-text-primary text-white section-padding"
      role="contentinfo"
    >
      <div className="container-wide">
        ...
        >
          {/* Brand */}
          <div>
            <h3 className="font-display font-bold text-2xl mb-4">{siteConfig.organizationName}</h3>
            <p className="text-white/80">
              Empowering every child to find their voice through specialized training and compassionate support.
            </p>
          </div>
            ...
            <ul className="space-y-2" role="list">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-white/80 hover:text-pastel-yellow transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
            ...
            <div className="flex gap-4">
              {socialIcons.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-white/10 hover:bg-pastel-blue flex items-center justify-center transition-colors"
        ...
        <div className="pt-8 border-t border-white/20 text-center text-white/70 text-sm">
          <p>&copy; {currentYear} {siteConfig.organizationName}. All rights reserved.</p>
          <a href="#privacy" className="hover:text-pastel-yellow transition-colors mt-2 inline-block">
            Privacy Policy
          </a>
        </div>
      </div>
